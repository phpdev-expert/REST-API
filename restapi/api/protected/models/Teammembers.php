...
class Teammembers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('team_id, user_id', 'length', 'max'=>20),
			array('joined_time, time_inserted, time_updated', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('team_id, user_id, joined_time, active, time_inserted, time_updated, deleted', 'safe', 'on'=>'search'),
		);
	}
